...
class Convert{
	/*
	* Convierte un código ISO de 2 digitos al nombre del país [En inglés]
	*
	* @Acceso: 		Público
	* @Parámetro: 	String
	* @Retorna: 	String
	...
	*/
	...
	{
		/*
		* Generamos una variable inicial por si es que el código no está disponible
		* El país sea vacío y retorne un vacío.
		*/
		$country = "";
	...
	/*
	* Convierte un código ISO de 2 digitos al continente dónde se encuentra el país [Inglés]
	* @Acceso: 		Público
	* @Parámetro: 	String
	* @Retorna: 	String
	* @Para Hacer:	Traducir
	*/
	...
	/*
	* Convierte el estado del código a su descripción correspondiente [Inglés]
	* @Acceso: 		Público
	* @Parámetro: 	Int
	* @Retorna: 	String
	* @Para Hacer:	Traducir
	*/
	public function httpStatus($code)
	{
		...
		if ( isset( $codeToDesc[$code] ) )
            return $codeToDesc[$code];
        else
            return '';
	}
	/*
	* Convierte la extensión de un archivo a un tipo de archivo
	* @Acceso: 		Público
	* @Parámetro: 	String
	* @Retorna: 	String
	* @Para Hacer:	Completo
	*/
	public function fileExtType($Extension)
	{
        ...
        foreach ( $extensionToType as $type => $extensions )
